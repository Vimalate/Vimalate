    ...
    themeConfig: {
        ...
        nav: [           
            ...
            //格式二：添加下拉菜单，link指向的文件路径
            {
                ...
                items: [
                    { text: 'CSS', link: '/blog/CSS-Library/那些奇妙的 CSS .md' },  
                    //点击标签会跳转至link的markdown文件生成的页面
                    { text: 'Javascript', link: '/blog/Javascript-Library/聊聊原型和原型链' },
                ]
            },
            {
                text: '每日学习',  //默认显示        
                ...
                items: [
                    { text: 'LeetCode', link: '/LeetCode-Library/121-买卖股票最佳时机' },  
                    //点击标签会跳转至link的markdown文件生成的页面
